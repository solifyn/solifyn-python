...
class SupportedCurrenciesResponseDto(BaseModel):
    """
    SupportedCurrenciesResponseDto
    """ # noqa: E501
    label: StrictStr = Field(description="The label display name of the currency")
    value: StrictStr = Field(description="The currency code")
