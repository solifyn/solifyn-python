...
class ProductUpdate(BaseModel):
    ...
    ProductUpdate
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Product display name.")
    ...
    currency: Optional[StrictStr] = Field(default='USD', description="Product pricing currency.")
    image_url: Optional[StrictStr] = Field(default=None, description="URL of the product cover image.", alias="imageUrl")
    tax_category: Optional[StrictStr] = Field(default=None, description="Tax classification.", alias="taxCategory")
