...
class Product(BaseModel):
    ...
    has_discord_access: StrictBool = Field(description="Whether the product includes Discord role access.", alias="hasDiscordAccess")
    discord_guild_id: StrictStr = Field(description="Discord Guild (Server) ID to grant access to.", alias="discordGuildId")
    discord_role_id: StrictStr = Field(description="Discord Role ID to assign to the user.", alias="discordRoleId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hasDiscordAccess": obj.get("hasDiscordAccess"),
