...
class DisputeList(BaseModel):
    ...
    DisputeList
    """ # noqa: E501
    data: List[Dispute] = Field(description="List of disputes")
    meta: DisputeListMetaDto = Field(description="Pagination metadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Dispute.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": DisputeListMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
