...
class LicenseValidationResponse(BaseModel):
    ...
    success: StrictBool
    valid: StrictBool
    license: LicenseSubDto
    __properties: ClassVar[List[str]] = ["success", "valid", "license"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "valid": obj.get("valid"),
            "license": LicenseSubDto.from_dict(obj["license"]) if obj.get("license") is not None else None
        })
        return _obj
