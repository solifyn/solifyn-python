...
class BillingApi:
    ...
    def billing_get_plans(
        ...
        _param = self._billing_get_plans_serialize(
    ...
    @validate_call
    def billing_get_plans_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def billing_get_plans_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _billing_get_plans_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
