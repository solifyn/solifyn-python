...
class CustomerListResponseDto(BaseModel):
    ...
    """ # noqa: E501
    items: List[CustomerResponseDto] = Field(description="List of customers")
    total_count: Union[StrictFloat, StrictInt] = Field(description="Total count of customers matching the filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CustomerResponseDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
