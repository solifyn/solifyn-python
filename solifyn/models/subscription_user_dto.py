...
class SubscriptionUserDto(BaseModel):
    """
    SubscriptionUserDto
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID of the user")
    username: StrictStr = Field(description="The username of the user")
    name: StrictStr = Field(description="The full name of the user")
    email: StrictStr = Field(description="The email address of the user")
    __properties: ClassVar[List[str]] = ["id", "username", "name", "email"]
