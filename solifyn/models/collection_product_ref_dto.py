...
class CollectionProductRefDto(BaseModel):
    """
    CollectionProductRefDto
    """ # noqa: E501
    id: StrictStr = Field(description="The public product identifier (whopId or internal ID)")
    quantity: Union[StrictFloat, StrictInt] = Field(description="Quantity of this product in the collection")
