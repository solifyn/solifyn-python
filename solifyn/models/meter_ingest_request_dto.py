...
class MeterIngestRequestDto(BaseModel):
    """
    MeterIngestRequestDto
    """ # noqa: E501
    events: List[MeterIngestEventDto] = Field(description="List of usage events to ingest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [MeterIngestEventDto.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
