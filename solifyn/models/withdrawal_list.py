...
class WithdrawalList(BaseModel):
    ...
    WithdrawalList
    """ # noqa: E501
    items: List[Withdrawal] = Field(description="List of withdrawals")
    total_count: Union[StrictFloat, StrictInt] = Field(description="Total count of withdrawals matching filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Withdrawal.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
