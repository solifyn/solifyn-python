...
class OperationalWebhookEndpointListResponseDto(BaseModel):
    """
    OperationalWebhookEndpointListResponseDto
    """ # noqa: E501
    data: List[OperationalWebhookEndpointResponseDto]
    done: StrictBool
    iterator: Optional[Dict[str, Any]] = None
    prev_iterator: Optional[Dict[str, Any]] = Field(default=None, alias="prevIterator")
    __properties: ClassVar[List[str]] = ["data", "done", "iterator", "prevIterator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OperationalWebhookEndpointResponseDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "done": obj.get("done"),
            "iterator": obj.get("iterator"),
            "prevIterator": obj.get("prevIterator")
        })
        return _obj
