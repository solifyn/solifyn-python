...
class LicensesUpdateRequest(BaseModel):
    """
    LicensesUpdateRequest
    """ # noqa: E501
    status: Optional[StrictStr] = None
    activation_limit: Optional[StrictInt] = Field(default=None, alias="activationLimit")
    expires_at: Optional[datetime] = Field(default=None, alias="expiresAt")
    __properties: ClassVar[List[str]] = ["status", "activationLimit", "expiresAt"]
