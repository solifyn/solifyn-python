...
with solifyn.ApiClient(configuration) as api_client:
    ...
    api_instance = solifyn.PartnerApi(api_client)

    try:
        api_instance.partner_controller_get_partner_commissions()
    except Exception as e:
        print("Exception when calling PartnerApi->partner_controller_get_partner_commissions: %s\n" % e)
```
...
with solifyn.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PartnerApi->partner_controller_get_partner_stats: %s\n" % e)
```
