...
class WebhookDeliveryResponseDto(BaseModel):
    ...
    response_status: Optional[Dict[str, Any]] = Field(default=None, alias="responseStatus")
    response_body: Optional[Dict[str, Any]] = Field(default=None, alias="responseBody")
    duration_ms: Optional[Dict[str, Any]] = Field(default=None, alias="durationMs")
    status: StrictStr
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "endpointId", "event", "payload", "responseStatus", "responseBody", "durationMs", "status", "createdAt"]
