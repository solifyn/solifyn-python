...
class OperationalWebhookEndpointHeadersResponseDto(BaseModel):
    """
    OperationalWebhookEndpointHeadersResponseDto
    """ # noqa: E501
    headers: Dict[str, Any] = Field(description="Key-value headers sent with the webhook.")
    sensitive: List[StrictStr] = Field(description="List of sensitive header keys (e.g. Authorization) that are masked.")
    __properties: ClassVar[List[str]] = ["headers", "sensitive"]
