...
class DisputeListMetaDto(BaseModel):
    """
    DisputeListMetaDto
    """ # noqa: E501
    total: Union[StrictFloat, StrictInt] = Field(description="Total count of disputes")
    page: Union[StrictFloat, StrictInt] = Field(description="Current page number")
    limit: Union[StrictFloat, StrictInt] = Field(description="Limit of items per page")
    total_pages: Union[StrictFloat, StrictInt] = Field(description="Total number of pages", alias="totalPages")
    __properties: ClassVar[List[str]] = ["total", "page", "limit", "totalPages"]
