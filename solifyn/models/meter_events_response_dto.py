...
class MeterEventsResponseDto(BaseModel):
    """
    ...
    items: List[MeterUsageEventDto] = Field(description="List of recent usage events.")
    count: Union[StrictFloat, StrictInt] = Field(description="Number of returned usage events.")
    __properties: ClassVar[List[str]] = ["meterId", "items", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [MeterUsageEventDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "count": obj.get("count")
        })
        return _obj
