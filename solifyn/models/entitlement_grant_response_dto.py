...
class EntitlementGrantResponseDto(BaseModel):
    """
    EntitlementGrantResponseDto
    """ # noqa: E501
    id: StrictStr = Field(description="The unique entitlement grant ID.")
    business_id: StrictStr = Field(description="The business ID context.", alias="businessId")
    customer_id: StrictStr = Field(description="The customer ID.", alias="customerId")
    payment_id: Optional[StrictStr] = Field(default=None, description="Associated payment transaction ID.", alias="paymentId")
    product_id: StrictStr = Field(description="The purchased product ID.", alias="productId")
    type: StrictStr = Field(description="The type of entitlement (e.g. GITHUB, DISCORD, TELEGRAM).")
