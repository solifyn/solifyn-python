...
class TestMeterUsageEventDto(unittest.TestCase):
    """MeterUsageEventDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterUsageEventDto:
        ...
        """
        model = MeterUsageEventDto()
        if include_optional:
            return MeterUsageEventDto(
    ...
    def testMeterUsageEventDto(self):
        """Test MeterUsageEventDto"""
