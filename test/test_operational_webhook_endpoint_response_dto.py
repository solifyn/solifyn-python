...
class TestOperationalWebhookEndpointResponseDto(unittest.TestCase):
    """OperationalWebhookEndpointResponseDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalWebhookEndpointResponseDto:
        """Test OperationalWebhookEndpointResponseDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalWebhookEndpointResponseDto`
        """
        model = OperationalWebhookEndpointResponseDto()
        if include_optional:
    ...
    def testOperationalWebhookEndpointResponseDto(self):
        """Test OperationalWebhookEndpointResponseDto"""
