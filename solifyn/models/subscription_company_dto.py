...
class SubscriptionCompanyDto(BaseModel):
    """
    SubscriptionCompanyDto
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID of the company")
    title: StrictStr = Field(description="The title/name of the company")
