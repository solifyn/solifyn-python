...
class PayoutMethodList(BaseModel):
    """
    PayoutMethodList
    """ # noqa: E501
    data: List[PayoutMethod] = Field(description="List of payout methods available for the business")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PayoutMethod.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
