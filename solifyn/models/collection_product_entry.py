...
class CollectionProductEntry(BaseModel):
    """
    CollectionProductEntry
    """ # noqa: E501
    id: StrictStr = Field(description="The product ID (whopId or internal database ID)")
    quantity: Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="Quantity of this product in the collection. Required, defaults to 1.")
