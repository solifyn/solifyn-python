...
class SubscriptionList(BaseModel):
    ...
    SubscriptionList
    """ # noqa: E501
    items: List[Subscription] = Field(description="List of customer subscriptions")
    total_count: Union[StrictFloat, StrictInt] = Field(description="Total count of subscriptions matching the filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Subscription.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
