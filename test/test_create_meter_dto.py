...
class TestCreateMeterDto(unittest.TestCase):
    """CreateMeterDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMeterDto:
        """Test CreateMeterDto
        ...
        """
        model = CreateMeterDto()
        if include_optional:
            return CreateMeterDto(
