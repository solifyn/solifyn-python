...
class TestUpdateEntitlementDto(unittest.TestCase):
    """UpdateEntitlementDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEntitlementDto:
        ...
        """
        model = UpdateEntitlementDto()
        if include_optional:
            return UpdateEntitlementDto(
    ...
    def testUpdateEntitlementDto(self):
        """Test UpdateEntitlementDto"""
