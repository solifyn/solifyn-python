...
class TestPayoutVerification(unittest.TestCase):
    """PayoutVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutVerification:
        """Test PayoutVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutVerification`
        """
        model = PayoutVerification()
        if include_optional:
    ...
    def testPayoutVerification(self):
        """Test PayoutVerification"""
