...
class SubscriptionPlanDto(BaseModel):
    ...
    SubscriptionPlanDto
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID of the plan")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Additional metadata associated with the plan")
