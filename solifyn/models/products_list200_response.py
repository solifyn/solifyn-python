...
class ProductsList200Response(BaseModel):
    ...
    """ # noqa: E501
    items: List[Product]
    pagination: ProductsList200ResponsePagination
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Product.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "pagination": ProductsList200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
