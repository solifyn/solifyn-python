...
class BusinessFullCreateResponse(BaseModel):
    """
    BusinessFullCreateResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates if creation was successful")
    business_id: StrictStr = Field(description="The newly created business ID", alias="businessId")
    __properties: ClassVar[List[str]] = ["success", "businessId"]
