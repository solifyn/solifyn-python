...
class PayoutAccountLink(BaseModel):
    ...
    PayoutAccountLink
    """ # noqa: E501
    url: StrictStr = Field(description="The URL redirecting to the Stripe Express onboarding/portal")
    expires_at: datetime = Field(description="Expiration timestamp of the link")
