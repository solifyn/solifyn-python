...
class UpdateCollectionProductDto(BaseModel):
    """
    UpdateCollectionProductDto
    """ # noqa: E501
    quantity: Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="New quantity of this product in the collection.")
