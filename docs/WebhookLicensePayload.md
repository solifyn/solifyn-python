...
webhook_license_payload_instance = WebhookLicensePayload.from_json(json)
# print the JSON string representation of the object
print(WebhookLicensePayload.to_json())

# convert the object into a dict
webhook_license_payload_dict = webhook_license_payload_instance.to_dict()
# create an instance of WebhookLicensePayload from a dict
webhook_license_payload_from_dict = WebhookLicensePayload.from_dict(webhook_license_payload_dict)
```
