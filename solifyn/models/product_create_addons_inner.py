...
class ProductCreateAddonsInner(BaseModel):
    """
    ...
    price_override: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="priceOverride")
    is_seat_addon: Optional[StrictBool] = Field(default=None, alias="isSeatAddon")
