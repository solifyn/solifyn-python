...
class CreateApiKeyDto(BaseModel):
    ...
    allow_write: Optional[StrictBool] = Field(default=True, description="Whether the API key is allowed to make mutating write requests.", alias="allowWrite")
    __properties: ClassVar[List[str]] = ["name", "allowWrite"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "allowWrite": obj.get("allowWrite") if obj.get("allowWrite") is not None else True
        })
        return _obj
