...
class TestBusinessCreate(unittest.TestCase):
    """BusinessCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCreate:
        """Test BusinessCreate
