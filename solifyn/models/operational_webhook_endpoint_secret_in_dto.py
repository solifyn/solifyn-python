...
class OperationalWebhookEndpointSecretInDto(BaseModel):
    """
    OperationalWebhookEndpointSecretInDto
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Optional custom endpoint signing secret (base64 encoded random bytes optionally prefixed with whsec_). If not set, a new random secret is generated.")
