...
class LicensesVerifyRequest(BaseModel):
    """
    LicensesVerifyRequest
    """ # noqa: E501
    key: StrictStr = Field(description="The license key to validate.")
    product_id: StrictStr = Field(description="The product ID associated with the license.", alias="productId")
    __properties: ClassVar[List[str]] = ["key", "productId"]
