...
class ProductsList200ResponsePagination(BaseModel):
    """
    ProductsList200ResponsePagination
    """ # noqa: E501
    total_count: StrictInt = Field(description="Total number of items matching filters.")
    max_page: StrictInt = Field(description="Maximum page index available based on current page size.")
    __properties: ClassVar[List[str]] = ["total_count", "max_page"]
