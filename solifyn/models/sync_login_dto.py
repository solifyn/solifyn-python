...
class SyncLoginDto(BaseModel):
    """
    SyncLoginDto
    """ # noqa: E501
    live_token: StrictStr = Field(description="The JWT access token from the Live API server", alias="liveToken")
    __properties: ClassVar[List[str]] = ["liveToken"]
