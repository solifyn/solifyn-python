...
class MeterQuantitiesResponseDto(BaseModel):
    """
    Represents aggregated usage quantities and calculated product costs for a meter within a selected date range.
    """ # noqa: E501
    meter_id: StrictStr = Field(description="The unique meter ID.", alias="meterId")
    name: StrictStr = Field(description="Meter display name.")
    total_usage: Union[StrictFloat, StrictInt] = Field(description="Total usage within the selected time range.", alias="totalUsage")
    costs: List[MeterQuantitiesCostDto] = Field(description="Cost breakdown for products attached to the meter.")
    __properties: ClassVar[List[str]] = ["meterId", "name", "totalUsage", "costs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "costs": [MeterQuantitiesCostDto.from_dict(_item) for _item in obj["costs"]] if obj.get("costs") is not None else None
        })
        return _obj
