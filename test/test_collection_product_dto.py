...
class TestCollectionProductDto(unittest.TestCase):
    """CollectionProductDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionProductDto:
        """Test CollectionProductDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionProductDto`
        """
        model = CollectionProductDto()
        if include_optional:
    ...
    def testCollectionProductDto(self):
        """Test CollectionProductDto"""
