...
class TestPayoutAccountLink(unittest.TestCase):
    """PayoutAccountLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutAccountLink:
        """Test PayoutAccountLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutAccountLink`
        """
        model = PayoutAccountLink()
        if include_optional:
    ...
    def testPayoutAccountLink(self):
        """Test PayoutAccountLink"""
