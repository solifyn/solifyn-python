...
class PayoutVerificationList(BaseModel):
    """
    PayoutVerificationList
    """ # noqa: E501
    data: List[PayoutVerification] = Field(description="List of verifications for the payout account")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PayoutVerification.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
